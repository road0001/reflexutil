...
package net.kandov.reflexutil {
	...
	implements IMXMLObject {
		...
		private var application:UIComponent;
		...
		public function ReflexUtil() {
			...
			var app:mx.core.Application = FlexGlobals.topLevelApplication as mx.core.Application;
			var sparkApp:spark.components.Application = FlexGlobals.topLevelApplication as spark.components.Application;
			
			if(app) {
				application = mx.core.Application(app);
			} else {
				if(sparkApp){
					application = spark.components.Application(sparkApp);
				}
			}
